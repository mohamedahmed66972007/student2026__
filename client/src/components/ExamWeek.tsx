          ...
          <AccordionContent>
            <div className="border-t border-gray-200 dark:border-gray-700">
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-[11px] xs:text-[13px] sm:text-base">
                  <thead className="bg-gray-50 dark:bg-gray-900">
                    <tr>
                      <th className="px-2 sm:px-6 py-2 sm:py-3 text-right text-[10px] xs:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">اليوم</th>
                      <th className="px-2 sm:px-6 py-2 sm:py-3 text-right text-[10px] xs:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">المادة</th>
                      <th className="px-2 sm:px-6 py-2 sm:py-3 text-right text-[10px] xs:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">التاريخ</th>
                      <th className="px-2 sm:px-6 py-2 sm:py-3 text-right text-[10px] xs:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">الدروس المقررة</th>
                      {isAdmin && (
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {exams.length > 0 ? (
                      [...exams]
                        ...
                        .map((exam) => (
                          <tr key={exam.id}>
                            <td className="px-2 sm:px-6 py-2 sm:py-4 whitespace-nowrap">{exam.day}</td>
                            <td className="px-2 sm:px-6 py-2 sm:py-4 whitespace-nowrap flex items-center">
                              <SubjectIcon subject={exam.subject as any} className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                              {getSubjectName(exam.subject as any)}
                            </td>
                            <td className="px-2 sm:px-6 py-2 sm:py-4 whitespace-nowrap">{exam.date}</td>
                            <td className="px-2 sm:px-6 py-2 sm:py-4">
                              <ul className="list-disc list-inside text-[11px] xs:text-sm text-gray-600 dark:text-gray-300">
